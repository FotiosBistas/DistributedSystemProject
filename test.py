...
if __name__ == '__main__':
    ...
    conf = {
        ...
        'sasl.password': 'Endpoint=sb://cartopics.servicebus.windows.net/;SharedAccessKeyName=producer;SharedAccessKey=z0ggyqgTFmJC42++Gxpl4Mhg3ednL8Gbk+AEhJj3Ud8=;EntityPath=cars',          #replace
